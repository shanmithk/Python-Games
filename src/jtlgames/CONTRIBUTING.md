...
Welcome to `jtlgames` contributor's guide.
...
If you experience bugs or general issues with `jtlgames`, please have a look
...
You can help improve `jtlgames` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`jtlgames` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `jtlgames`'s files. While this mechanism can
...
```
conda create -n jtlgames python=3 six virtualenv pytest pytest-cov
conda activate jtlgames
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/jtlgames.git
   cd jtlgames
   ```
...
5. Install [pre-commit]:
   ...
   `jtlgames` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/jtlgames
[issue tracker]: https://github.com/<USERNAME>/jtlgames/issues
